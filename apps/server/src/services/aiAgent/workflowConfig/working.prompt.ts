export const workingPrompt =
  ...
  'Keep a closure-oriented state while you work. closure_state.best_known_state should capture the strongest progress or closest-to-success state achieved so far. closure_state.live_blocker should name the single most important issue currently preventing accept. closure_state.must_preserve should list concrete results, artifacts, or established facts that must not be lost on the next pass.\n\n' +
  ...
  'If verification feedback is present, preserve what is confirmed, target the blocking gap first, and gather the missing evidence before starting broad new exploration.\n\n' +
