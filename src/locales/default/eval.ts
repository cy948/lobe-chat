export default {
  ...
  'experiment.card.benchmarkCount': '{{count}} benchmark{{count, plural, one {} other {s}}}',
  'experiment.card.datasetCount': '{{count}} datasets',
  'experiment.card.empty': 'No experiments yet',
  'experiment.card.emptyHint':
    'Create an experiment to organize scoped datasets and run iterations.',
