...
const isEditorButtonDisabled = (s: FlowStore) => isFlowAIGenerating(s) || s.isCreatingMessage;

const isMessageGenerating = (id: string) => (s: FlowStore) => s.chatLoadingIds.includes(id);
